...
import {colors, appStyles, sizes, baseStyle} from '../../services';
import {
  BallIndicator,
  BarIndicator,
  DotIndicator,
...
import {Wrapper, Spacer, Text} from '../../components';
...
export const Tertiary = ({}) => {
  return (
    <Wrapper
      ...
      style={[
        {backgroundColor: 'transparent', marginTop: baseStyle.marginTop(75)},
      ]}>
      <UIActivityIndicator color={colors.appColor1} size={sizes.icons.xxl} />
    </Wrapper>
  );
};
